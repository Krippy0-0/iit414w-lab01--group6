...
![Calibration curve for `is_top10` on the held-out test set.](../demo_day/cal_top10.png)
...
![Calibration curve for `is_top5` on the held-out test set.](../demo_day/cal_top5.png)
